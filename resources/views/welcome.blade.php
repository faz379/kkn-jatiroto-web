...
<head>
  ...
  <title>KKN JATIROTO BUAYAN</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/logo-kkn.png" rel="icon">
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        <h1><a href="index.html"><img src="assets/img/logo-kkn.png" alt="" class="img-fluid"></a><a href="index.html">KKN JATIROTO</a></h1>
      ...
      <div class="header-social-links d-flex align-items-center">
        <a href="https://www.instagram.com/kknjatiroto_2024?igsh=MW9uNWl5bGNveWY1aw==" class="instagram"><i class="bi bi-instagram"></i></a>
      </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/foto-bareng.jpeg" class="img-fluid" alt="">
          </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Program Kerja</h2>
          <p>Program Kerja KKN Jatiroto 2024</p>
        </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Dokumentasi</h2>
          <p>Dokumenatsi pelaksanaan KKN Jatiroto 2024</p>
        </div>
